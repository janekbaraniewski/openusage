...
export default function OpenRouterView() {
  return (
    <Panel
      name="openrouter"
      status="OK"
    ...
    >
      ...
      <div className="text-[#7a829e] text-[10px]">
        $2.15 remaining &middot; today $14.71 &middot; week $105.78 &middot; 24 models
      </div>

      <Section title="Model Burn (credits)" />
      <ModelRow rank={1} name="moonshotai-kimi-k2-5" pct={21} metric="21% 15.9M tok · $462.25" />
      <ModelRow rank={2} name="deepseek-deepseek-v3-2" pct={13} metric="13% 12.4M tok · $675.30" />
      <ModelRow rank={3} name="qwen3-coder-flash" pct={17} metric="17% 11.4M tok" />
      ...
      <ModelRow rank={3} name="Sandbox" pct={18} metric="18% 4.7M tok · 4.1k req" />
      <ModelRow rank={4} name="Expense Tracker" pct={17} metric="17% 4.3M tok · 458 req" />
      <ModelRow rank={5} name="Pet Tracker" pct={5} metric="5% 618.7k tok · 2.2k req" />
      ...
      <div className="flex gap-px items-end h-3 my-1 ml-[25px]">
        {[
          { h: 80, c: "#ff90b2" }, { h: 55, c: "#f0a870" }, { h: 45, c: "#f2d28d" },
          { h: 40, c: "#9de9bd" }, { h: 15, c: "#7be3d6" }, { h: 10, c: "#c8a8ff" },
        ].map((d, i) => (
          <div key={i} className="w-[5px]" style={{ height: `${d.h}%`, backgroundColor: d.c }} />
        ))}
      </div>
      <div className="text-[10px] text-[#2a3045] ml-[25px]">
        Recipe Blog &middot; Workout Log &middot; Sandbox &middot; Expense Tra...
      </div>

      <Section title="Hosting Providers (credits)" />
      <ModelRow rank={1} name="novita" pct={28} metric="28% 14.4M tok · 1.2k req · $676.69" />
      <ModelRow rank={2} name="google-vertex" pct={15} metric="15% 13.3M tok · 5.1k req · $333.46" />
      <ModelRow rank={3} name="alibaba" pct={10} metric="10% 13.0M tok · $236.66" />
      <ModelRow rank={4} name="together" pct={10} metric="10% 13.0M tok · 481 req · $236.66" />
      <ModelRow rank={5} name="deepinfra" pct={5} metric="5% 12.6M tok · 5.4k · $120.03" />
      <ModelRow rank={6} name="fireworks" pct={10} metric="10% 12.2M tok · $241.76" />
      <ModelRow rank={7} name="siliconflow-int4" pct={8} metric="8% 8.3M tok · 1.6k2 req · $457.53" />
      ...
      <ModelRow rank={3} name="nvidia_nemotron-nano-9b-v2" pct={13} metric="13% 3.0k" />
      <ModelRow rank={4} name="moonshotai_kimi-k2-5" pct={13} metric="13% 3.0k" />
      <ModelRow rank={5} name="openai_gpt-o4s-r1203" pct={5} metric="5% 826" />
      ...
      <ModelRow rank={4} name="code" pct={1} metric="1% 1.3k req" />
      ...
      <div className="flex gap-0.5 items-end h-4 mt-1 ml-[25px]">
        ...
        <div className="text-[9px] text-[#2a3045] ml-1">Cost &middot; Req &middot; Tokens</div>
      </div>
