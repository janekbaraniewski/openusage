...
func buildDemoSnapshots() map[string]core.UsageSnapshot {
	...
	snaps["openrouter"] = core.UsageSnapshot{
		...
		Metrics: map[string]core.Metric{
			...
			"provider_openai_requests":         {Used: ptr(182), Unit: "requests", Window: "activity"},
			"provider_openai_cost_usd":         {Used: ptr(2.76), Unit: "USD", Window: "activity"},
			"provider_openai_input_tokens":     {Used: ptr(5800000), Unit: "tokens", Window: "activity"},
			"provider_openai_output_tokens":    {Used: ptr(810000), Unit: "tokens", Window: "activity"},
			"provider_openai_reasoning_tokens": {Used: ptr(190000), Unit: "tokens", Window: "activity"},
			"provider_anthropic_requests":      {Used: ptr(121), Unit: "requests", Window: "activity"},
			"provider_anthropic_cost_usd":      {Used: ptr(1.94), Unit: "USD", Window: "activity"},
			"provider_anthropic_input_tokens":  {Used: ptr(4400000), Unit: "tokens", Window: "activity"},
			"provider_anthropic_output_tokens": {Used: ptr(520000), Unit: "tokens", Window: "activity"},
			"provider_deepseek_requests":       {Used: ptr(94), Unit: "requests", Window: "activity"},
			"provider_deepseek_cost_usd":       {Used: ptr(0.78), Unit: "USD", Window: "activity"},
			"provider_deepseek_input_tokens":   {Used: ptr(2600000), Unit: "tokens", Window: "activity"},
			"provider_deepseek_output_tokens":  {Used: ptr(310000), Unit: "tokens", Window: "activity"},
			"provider_novita_requests":         {Used: ptr(67), Unit: "requests", Window: "activity"},
			"provider_novita_cost_usd":         {Used: ptr(0.59), Unit: "USD", Window: "activity"},
			"provider_novita_input_tokens":     {Used: ptr(2100000), Unit: "tokens", Window: "activity"},
			"provider_novita_output_tokens":    {Used: ptr(170000), Unit: "tokens", Window: "activity"},
			"client_openai_input_tokens":       {Used: ptr(5800000), Unit: "tokens", Window: "30d"},
			"client_openai_output_tokens":      {Used: ptr(810000), Unit: "tokens", Window: "30d"},
			"client_openai_reasoning_tokens":   {Used: ptr(190000), Unit: "tokens", Window: "30d"},
			"client_openai_total_tokens":       {Used: ptr(6800000), Unit: "tokens", Window: "30d"},
			"client_openai_requests":           {Used: ptr(182), Unit: "requests", Window: "30d"},
			"client_anthropic_input_tokens":    {Used: ptr(4400000), Unit: "tokens", Window: "30d"},
			"client_anthropic_output_tokens":   {Used: ptr(520000), Unit: "tokens", Window: "30d"},
			"client_anthropic_total_tokens":    {Used: ptr(4920000), Unit: "tokens", Window: "30d"},
			"client_anthropic_requests":        {Used: ptr(121), Unit: "requests", Window: "30d"},
			...
			"client_deepseek_requests":         {Used: ptr(94), Unit: "requests", Window: "30d"},
			"client_novita_input_tokens":       {Used: ptr(2100000), Unit: "tokens", Window: "30d"},
			"client_novita_output_tokens":      {Used: ptr(170000), Unit: "tokens", Window: "30d"},
			"client_novita_total_tokens":       {Used: ptr(2270000), Unit: "tokens", Window: "30d"},
			"client_novita_requests":           {Used: ptr(67), Unit: "requests", Window: "30d"},
		...
		Raw: map[string]string{
			...
			"byok_in_use":           "false",
			"activity_providers":    "openai, anthropic, deepseek, novita",
		...
		DailySeries: map[string][]core.TimePoint{
			...
			"tokens_client_openai":    demoSeries(now, 820000, 910000, 980000, 1050000, 1120000, 1200000, 1280000),
			"tokens_client_anthropic": demoSeries(now, 640000, 710000, 770000, 820000, 880000, 930000, 980000),
			"tokens_client_deepseek":  demoSeries(now, 290000, 340000, 390000, 430000, 470000, 500000, 530000),
			"tokens_client_novita":    demoSeries(now, 220000, 250000, 280000, 310000, 340000, 360000, 390000),
			"usage_client_openai":     demoSeries(now, 12, 18, 23, 28, 31, 34, 36),
			"usage_client_anthropic":  demoSeries(now, 10, 14, 18, 21, 23, 25, 27),
			"usage_client_deepseek":   demoSeries(now, 8, 10, 12, 14, 16, 16, 18),
			"usage_client_novita":     demoSeries(now, 6, 7, 9, 10, 11, 11, 13),
		},
