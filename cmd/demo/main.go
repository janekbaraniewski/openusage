...
func buildDemoSnapshots() map[string]core.UsageSnapshot {
	...
	snaps["copilot"] = core.UsageSnapshot{
		...
		Metrics: map[string]core.Metric{
			...
			"client_vcluster_total_tokens": {Used: ptr(234900), Unit: "tokens", Window: "7d"},
			"client_vcluster_input_tokens": {Used: ptr(188200), Unit: "tokens", Window: "7d"},
			"client_vcluster_output_tokens": {
				Used: ptr(46700), Unit: "tokens", Window: "7d",
			},
			"client_vcluster_sessions":           {Used: ptr(7), Unit: "sessions", Window: "7d"},
			"client_vcluster_agent_total_tokens": {Used: ptr(51300), Unit: "tokens", Window: "7d"},
			"client_vcluster_agent_input_tokens": {Used: ptr(42100), Unit: "tokens", Window: "7d"},
			"client_vcluster_agent_output_tokens": {
				Used: ptr(9200), Unit: "tokens", Window: "7d",
			},
			"client_vcluster_agent_sessions": {Used: ptr(1), Unit: "sessions", Window: "7d"},
		...
		DailySeries: map[string][]core.TimePoint{
			"tokens_client_vcluster":       demoSeries(now, 8300, 9200, 11100, 12400, 13800, 15700, 17700),
			"tokens_client_vcluster_agent": demoSeries(now, 2100, 2400, 2900, 3300, 3800, 4100, 4600),
	...
	snaps["claude-code"] = core.UsageSnapshot{
		...
		Metrics: map[string]core.Metric{
			...
			"client_vcluster_input_tokens":     {Used: ptr(62100000), Unit: "tokens", Window: "7d"},
			"client_vcluster_output_tokens":    {Used: ptr(21700000), Unit: "tokens", Window: "7d"},
			"client_vcluster_cached_tokens":    {Used: ptr(53200), Unit: "tokens", Window: "7d"},
			"client_vcluster_reasoning_tokens": {Used: ptr(13300), Unit: "tokens", Window: "7d"},
			"client_vcluster_total_tokens":     {Used: ptr(83800000), Unit: "tokens", Window: "7d"},
			"client_vcluster_sessions":         {Used: ptr(42), Unit: "sessions", Window: "7d"},
			"client_vcluster_requests":         {Used: ptr(890), Unit: "requests", Window: "7d"},
		...
		DailySeries: map[string][]core.TimePoint{
			...
			"tokens_client_vcluster":                demoSeries(now, 21300, 24700, 25900, 28100, 29400, 31800, 34600),
	...
	snaps["openrouter"] = core.UsageSnapshot{
		...
		Metrics: map[string]core.Metric{
			...
			// ── provider_* metrics (generation-resolved hosting providers) ──
			...
			// ── upstream_* metrics (activity endpoint hosting providers) ──
			...
			// ── client_* metrics (projects / app names) ──
			"client_openusage_input_tokens":       {Used: ptr(14200000), Unit: "tokens", Window: "30d"},
			"client_openusage_output_tokens":      {Used: ptr(1680000), Unit: "tokens", Window: "30d"},
			"client_openusage_total_tokens":       {Used: ptr(15880000), Unit: "tokens", Window: "30d"},
			"client_openusage_requests":           {Used: ptr(452), Unit: "requests", Window: "30d"},
			"client_openusage_cost_usd":           {Used: ptr(7.84), Unit: "USD", Window: "30d"},
			"client_dev_playground_input_tokens":  {Used: ptr(200000), Unit: "tokens", Window: "30d"},
			"client_dev_playground_output_tokens": {Used: ptr(120000), Unit: "tokens", Window: "30d"},
			"client_dev_playground_total_tokens":  {Used: ptr(320000), Unit: "tokens", Window: "30d"},
			"client_dev_playground_requests":      {Used: ptr(12), Unit: "requests", Window: "30d"},
			"client_dev_playground_cost_usd":      {Used: ptr(0.44), Unit: "USD", Window: "30d"},
			"client_openai_input_tokens":          {Used: ptr(5700000), Unit: "tokens", Window: "30d"},
			"client_openai_output_tokens":         {Used: ptr(680000), Unit: "tokens", Window: "30d"},
			"client_openai_total_tokens":          {Used: ptr(6380000), Unit: "tokens", Window: "30d"},
			"client_openai_requests":              {Used: ptr(186), Unit: "requests", Window: "30d"},
			"client_openai_cost_usd":              {Used: ptr(3.31), Unit: "USD", Window: "30d"},
			"client_anthropic_input_tokens":       {Used: ptr(4100000), Unit: "tokens", Window: "30d"},
			"client_anthropic_output_tokens":      {Used: ptr(490000), Unit: "tokens", Window: "30d"},
			"client_anthropic_total_tokens":       {Used: ptr(4590000), Unit: "tokens", Window: "30d"},
			"client_anthropic_requests":           {Used: ptr(135), Unit: "requests", Window: "30d"},
			"client_anthropic_cost_usd":           {Used: ptr(2.40), Unit: "USD", Window: "30d"},
			"client_deepseek_input_tokens":        {Used: ptr(2600000), Unit: "tokens", Window: "30d"},
			"client_deepseek_output_tokens":       {Used: ptr(310000), Unit: "tokens", Window: "30d"},
			"client_deepseek_total_tokens":        {Used: ptr(2910000), Unit: "tokens", Window: "30d"},
			"client_deepseek_requests":            {Used: ptr(84), Unit: "requests", Window: "30d"},
			"client_deepseek_cost_usd":            {Used: ptr(1.49), Unit: "USD", Window: "30d"},
			"client_novita_input_tokens":          {Used: ptr(1800000), Unit: "tokens", Window: "30d"},
			"client_novita_output_tokens":         {Used: ptr(200000), Unit: "tokens", Window: "30d"},
			"client_novita_total_tokens":          {Used: ptr(2000000), Unit: "tokens", Window: "30d"},
			"client_novita_requests":              {Used: ptr(59), Unit: "requests", Window: "30d"},
			"client_novita_cost_usd":              {Used: ptr(1.08), Unit: "USD", Window: "30d"},
		...
		Raw: map[string]string{
			...
			"client_usage":          "openai: 40%, anthropic: 29%, deepseek: 18%, novita: 13%",
		...
		DailySeries: map[string][]core.TimePoint{
			...
			"tokens_client_openusage":      demoSeries(now, 1900000, 2100000, 2300000, 2500000, 2700000, 2900000, 3100000),
			"tokens_client_dev_playground": demoSeries(now, 30000, 40000, 50000, 55000, 60000, 65000, 70000),
			"tokens_client_openai":         demoSeries(now, 680000, 820000, 960000, 1100000, 1250000, 1380000, 1520000),
			"tokens_client_anthropic":      demoSeries(now, 490000, 590000, 700000, 810000, 920000, 1010000, 1100000),
			"tokens_client_deepseek":       demoSeries(now, 310000, 380000, 440000, 500000, 570000, 640000, 700000),
			"tokens_client_novita":         demoSeries(now, 210000, 260000, 300000, 340000, 380000, 420000, 480000),
			"usage_client_openusage":       demoSeries(now, 52, 58, 64, 68, 72, 76, 80),
			"usage_client_dev_playground":  demoSeries(now, 1, 1, 2, 2, 2, 2, 3),
		},
