...
func buildDemoSnapshots() map[string]core.UsageSnapshot {
	...
	snaps["cursor-ide"] = core.UsageSnapshot{
		...
		Metrics: map[string]core.Metric{
			...
			"plan_spend":             {Used: ptr(459), Limit: ptr(900), Unit: "USD"},
			"plan_total_spend_usd":   {Used: ptr(459), Unit: "USD"},
			"spend_limit":            {Used: ptr(459), Limit: ptr(3600), Remaining: ptr(3141), Unit: "USD"},
			"individual_spend":       {Used: ptr(355.36), Unit: "USD"},
			"chat_quota": {
			...
			"model_claude-4.6-opus-high-thinking_input_tokens": {
				Used: ptr(784000), Unit: "tokens", Window: "month",
			},
			...
			"model_claude-4.5-opus-high-thinking_input_tokens": {
				Used: ptr(6200), Unit: "tokens", Window: "month",
			},
			"model_claude-4.5-opus-high-thinking_output_tokens": {
				Used: ptr(1900), Unit: "tokens", Window: "month",
			},
			"model_default_cost":         {Used: ptr(0), Unit: "USD"},
			"plan_bonus":                 {Used: ptr(20.93), Unit: "USD"},
			"plan_included":              {Used: ptr(20.00), Unit: "USD"},
			"requests_today":             {Used: ptr(645), Unit: "requests", Window: "today"},
			"total_ai_requests":          {Used: ptr(63400), Unit: "requests", Window: "month"},
			"client_ide_sessions":        {Used: ptr(62100), Unit: "sessions", Window: "month"},
			"client_ide_requests":        {Used: ptr(62100), Unit: "requests", Window: "month"},
			"source_ide_requests":        {Used: ptr(62100), Unit: "requests", Window: "month"},
			...
			"client_cli_agents_requests": {Used: ptr(1300), Unit: "requests", Window: "month"},
			"source_composer_requests":   {Used: ptr(61800), Unit: "requests", Window: "month"},
			"source_human_requests":      {Used: ptr(233), Unit: "requests", Window: "month"},
			"source_tab_requests":        {Used: ptr(101), Unit: "requests", Window: "month"},
			"composer_accepted_lines":    {Used: ptr(945), Unit: "lines", Window: "today"},
			"composer_suggested_lines":   {Used: ptr(530), Unit: "lines", Window: "today"},
			"tab_accepted_lines":         {Used: ptr(51), Unit: "lines", Window: "today"},
			"tab_suggested_lines":        {Used: ptr(345), Unit: "lines", Window: "today"},
			"code_added_lines":           {Used: ptr(74600), Unit: "lines", Window: "month"},
			"code_removed_lines":         {Used: ptr(18500), Unit: "lines", Window: "month"},
			"code_commits":               {Used: ptr(171), Unit: "commits", Window: "month"},
			"code_prompts":               {Used: ptr(898), Unit: "prompts", Window: "month"},
			"billing_cached_tokens":      {Used: ptr(36.0e6), Unit: "tokens", Window: "month"},
		},
		Resets: map[string]time.Time{
			"billing_cycle_end": now.Add(14*24*time.Hour + 15*time.Hour),
		},
		Raw: map[string]string{
			"account_email":       "demo.user@example.test",
			"plan_name":           "pro",
			"team_membership":     "team",
			"billing_cycle_start": now.Add(-14 * 24 * time.Hour).UTC().Format(time.RFC3339),
			"billing_cycle_end":   now.Add(14*24*time.Hour + 15*time.Hour).UTC().Format(time.RFC3339),
		},
		DailySeries: map[string][]core.TimePoint{
		...
		Message: "Team — $459 / $3600 team spend ($3141 remaining)",
	}
	...
	snaps["codex-cli"] = core.UsageSnapshot{
		...
		Metrics: map[string]core.Metric{
			...
			"rate_limit_code_review_primary":   {Used: ptr(0), Limit: ptr(100), Remaining: ptr(100), Unit: "%", Window: "5h"},
			...
			"model_gpt_5_3_codex_input_tokens": {
				Used: ptr(2170000000), Unit: "tokens", Window: "session",
			},
			"model_gpt_5_3_codex_output_tokens": {
				Used: ptr(160200000), Unit: "tokens", Window: "session",
			},
			"model_gpt_5_3_codex_cost_usd": {Used: ptr(9.72), Unit: "USD", Window: "session"},
			"model_gpt_5_1_codex_max_input_tokens": {
				Used: ptr(371100), Unit: "tokens", Window: "session",
			},
			"model_gpt_5_1_codex_max_output_tokens": {
				Used: ptr(119500000), Unit: "tokens", Window: "session",
			},
			...
			"model_gpt_5_2_codex_input_tokens": {
				Used: ptr(12700000), Unit: "tokens", Window: "session",
			},
			"model_gpt_5_2_codex_output_tokens": {
				Used: ptr(5800000), Unit: "tokens", Window: "session",
			},
			...
			"model_gpt_5_1_codex_mini_input_tokens": {
				Used: ptr(9400000), Unit: "tokens", Window: "session",
			},
			"model_gpt_5_1_codex_mini_output_tokens": {
				Used: ptr(3300000), Unit: "tokens", Window: "session",
			},
			...
			"client_desktop_app_total_tokens":  {Used: ptr(1794100000), Unit: "tokens", Window: "session"},
			"client_desktop_app_input_tokens":  {Used: ptr(1200000000), Unit: "tokens", Window: "session"},
			"client_desktop_app_output_tokens": {Used: ptr(594100000), Unit: "tokens", Window: "session"},
			"client_desktop_app_cached_tokens": {Used: ptr(2900), Unit: "tokens", Window: "session"},
			"client_desktop_app_sessions":      {Used: ptr(36), Unit: "sessions", Window: "today"},
			"client_cli_total_tokens":          {Used: ptr(567200000), Unit: "tokens", Window: "session"},
			"client_cli_input_tokens":          {Used: ptr(380000000), Unit: "tokens", Window: "session"},
			"client_cli_output_tokens":         {Used: ptr(187200000), Unit: "tokens", Window: "session"},
			...
			"client_cli_sessions":              {Used: ptr(39), Unit: "sessions", Window: "today"},
			"client_ide_total_tokens":          {Used: ptr(119500000), Unit: "tokens", Window: "session"},
			"client_ide_input_tokens":          {Used: ptr(79900000), Unit: "tokens", Window: "session"},
			"client_ide_output_tokens":         {Used: ptr(39600000), Unit: "tokens", Window: "session"},
			...
			"client_ide_sessions":              {Used: ptr(8), Unit: "sessions", Window: "today"},
		},
		Resets: map[string]time.Time{
		...
		Raw: map[string]string{
			...
			"client_usage":  "Desktop App 72%, CLI 23%, IDE 5%",
		},
		DailySeries: map[string][]core.TimePoint{
		...
		Message: "Secondary limit exhausted; primary and code review available",
	}
