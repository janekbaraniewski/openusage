...
func dashboardWidget() core.DashboardWidget {
	cfg := providerbase.CodingToolDashboard(
		...
		providerbase.WithMetricLabels(map[string]string{
			...
			"codex_credit_daily_average":              "Daily Credit Average",
			"codex_credit_projected_credits_at_reset": "Expected at Reset",
			"codex_credit_projected_reserve_at_reset": "Projected Reserve",
